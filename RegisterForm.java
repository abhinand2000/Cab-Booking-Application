        ...
        else
        {
            if (conn.popup_message(userid_text.getText()) != 1) 
            {
                ...
                {    
                    ...
                    {
                        conn.insert_customer("INSERT INTO customerdata(name,email,phonenumber,username,password,wallet) VALUES ('"+name_text.getText()+"','"+email_text.getText()+"','"+phone_text.getText()+"','"+userid_text.getText()+"','"+password_text.getText()+"',0.0)");
                        //Customer C=new Customer();
                        //cdb.registerAccount(name_text.getText(),userid_text.getText(),email_text.getText(),password_text.getText(),phone_text.getText(), C);
