...
//    Connection con;
   ...
   private Customer C=new Customer();
    ...
    public AddMoney(Customer C,CustomerDatabase cdb,DriverDatabase ddb,boolean flag) {
        this.C=C;
        this.cdb=cdb;
        this.ddb=ddb;
        bal=C.getwallet();
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(490, 413));
